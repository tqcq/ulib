...
// make_optional
template<typename T>
constexpr tl::optional<tl::detail::decay_t<T>> make_optional(T&& v) {
    return tl::make_optional(std::forward<T>(v));
}

template<typename T, typename... Args>
constexpr tl::optional<T> make_optional(Args&&... args) {
    return tl::make_optional<T>(std::forward<Args>(args)...);
}

template<typename T, typename U, typename... Args>
constexpr tl::optional<T> make_optional(std::initializer_list<U> il, Args&&... args) {
